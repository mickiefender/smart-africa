...
export function TestimonialsSection() {
  ...
  const testimonials = [
    ...
    },
    {
      name: "Kwame Asante",
      role: "Entrepreneur",
      company: "Ghana Ventures",
      image: "/young-african-entrepreneur.jpg",
      rating: 5,
    ...
    },
    {
      ...
      image: "/professional-african-woman-smiling.jpg",
      rating: 5,
    ...
    },
    {
      ...
      image: "/african-business-consultant.jpg",
      rating: 5,
      text: "Switching to Smart Africa's digital cards was the best decision for my consulting business. The professional look and seamless sharing have impressed all my clients.",
